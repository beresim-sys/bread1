...
const STEPS = [
  ...
  },
  {
    ...
    name: "קיפול 3",
    duration: 45 * 60,
    description: "מבצעים קיפול שלישי ללא מתיחה. הבצק הופך לחלק, מתוח ויציב יותר.",
  },
  {
    id: 5,
    ...
    description: (
      <span>
        מבצעים קיפול אחרון ועדין במיוחד. לאחר מכן משאירים את הבצק להתפחה ארוכה בטמפרטורת החדר בקערה מכוסה, עד שהוא תופח בכ-30-50% ומפתח בועות עדינות. שימו לב לטמפרטורה בחוץ. אם מדובר ביום חם - בין שעתיים ל-4 שעות. אם קריר (ובמיוחד בחורף) - לעטוף בשמיכה.
        <strong className="block mt-1.5 font-bold text-stone-800">
          אם תרצו להכין פוקצ'ה, ניתן לעצור בשלב זה, להתפיח את הבצק לשעתיים בטמפ' החדר, לעצב את הפוקצה עם תוספות, ולאפות.
        </strong>
      </span>
    ),
  },
  {
    ...
    description: "מוציאים את הבצק למשטח עבודה. מותחים לצדדים ליצירת מלבן, ומקפלים: שליש תחתון עד האמצע, שליש עליון עד האמצע ומגלגלים מצד אחד לצד השני. מבצעים shaping - עיצוב החלק העליון ע\"י \"גרירה\" של הבצק. בשלב המתיחה ניתן להוסיף תוספות שונות (זיתים, בצל מטוגן, גרעינים). מעבירים לסלסילת התפחה מקומחת ומכניסים למקרר ל-7 שעות לפחות.",
  },
  {
    id: 7,
    name: "אפייה עם מכסה",
    duration: 45 * 60,
    description: "מחממים מראש תנור ל-250 מעלות עם סיר יצוק בפנים. מפזרים סולת על פני הבצק, הופכים אותו על נייר אפיה, מקמחים מלמעלה וחורצים את כיכר הלחם הקרה, מעבירים בזהירות לסיר, סוגרים את המכסה ואופים כדי לכלוא את האדים.",
  },
  {
    id: 8,
    name: "אפייה ללא מכסה",
    duration: 10 * 60,
    description: "מסירים בזהירות את מכסה הסיר. ממשיכים לאפות כדי לאפשר לקרום להפוך לשחום, עמוק ופריך.",
  },
  {
    id: 9,
    name: "הלחם מוכן! 🥖🎉",
    ...
    <div dir="rtl" className="min-h-screen bg-stone-100 flex justify-center py-0 sm:py-8 font-sans antialiased text-stone-800">
      <div className="max-w-md w-full bg-stone-50 min-h-screen sm:min-h-[850px] sm:rounded-3xl shadow-2xl flex flex-col justify-between overflow-hidden border-0 sm:border border-stone-200 relative">
        ...
        <header className="p-5 pb-3 bg-white/80 backdrop-blur-md border-b border-stone-200/60 z-10 flex justify-between items-center">
          ...
          {/* Header Action Link (Prep reset) */}
          {activeTab === 'prep' && !prepTimerActive && (
            <button 
