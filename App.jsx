...
const STEPS = [
  ...
  },
  {
    ...
    description: "מבצעים קיפול אחרון ועדין במיוחד. לאחר מכן משאירים את הבצק להתפחה ארוכה בטמפרטורת החדר בקערה מכוסה, עד שהוא תופח בכ-30-50% ומפתח בועות עדינות. שימו לב לטמפרטורה בחוץ. אם מדובר ביום חם - בין שעתיים ל-4 שעות. אם קריר (ובמיוחד בחורף) - לעטוף בשמיכה.",
  },
  {
    id: 6,
