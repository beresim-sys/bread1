...
const STEPS = [
  {
    ...
    description: "מערבבים את הקמח, המים, המחמצת והמלח עד לקבלת בצק אחיד. מכסים במגבת לחה ומניחים לבצק לנוח.",
    hasIngredients: true,
    hasCheckbox: true,
  ...
  },
  {
    ...
    name: "קיפול 1",
    duration: 45 * 60,
    description: "מבצעים קיפול עדין של הבצק מארבעת הצדדים (מרימים קצה אחד, מותחים למעלה ומקפלים למרכז, ומסובבים את הקערה). קיפול זה מתחיל לבנות את רשת הגלוטן.",
  },
  {
    id: 3,
    name: "קיפול 2",
    duration: 45 * 60,
    description: "מבצעים קיפול שני. תרגישו שהבצק מתחיל לקבל גוף, אלסטיות והתנגדות.",
  },
  {
    id: 4,
    name: "קיפול 3",
